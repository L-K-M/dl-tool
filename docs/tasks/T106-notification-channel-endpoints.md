...
```
$ go test -race -count=1 -v -run 'TestChannelCrudAllKinds|TestSecretNeverReturned|TestRedactedLeavesSecret|TestNullClearsSecret|TestEventMaskFilters|TestKindImmutable|TestDuplicateNameConflict|TestTestReturnsRawUpstreamReply|TestUnknownConfigKeyRejected|TestConfigURLBlocked|TestEventMaskRejectsEmptyEntries|TestUnreachableChannelReply|TestChannelNotFound' ./internal/api/
--- PASS: TestChannelCrudAllKinds (0.46s)
--- PASS: TestSecretNeverReturned (0.42s)
--- PASS: TestRedactedLeavesSecret (0.39s)
--- PASS: TestNullClearsSecret (0.40s)
--- PASS: TestEventMaskFilters (0.37s)
--- PASS: TestKindImmutable (0.39s)
--- PASS: TestDuplicateNameConflict (0.40s)
--- PASS: TestTestReturnsRawUpstreamReply (0.42s)
--- PASS: TestUnknownConfigKeyRejected (0.43s)
--- PASS: TestConfigURLBlocked (0.41s)
--- PASS: TestEventMaskRejectsEmptyEntries (0.37s)
--- PASS: TestUnreachableChannelReply (0.45s)
--- PASS: TestChannelNotFound (0.42s)
ok  	github.com/L-K-M/dl-tool/internal/api	6.700s
```
