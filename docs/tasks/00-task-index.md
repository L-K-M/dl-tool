...
| [T071](T071-commit-grabs-and-run-rule.md) | Commit rule matches as tasks and run a rule against existing items | T020, T024, T065, T066, T069, T070 | done |
...
| T071 | Commit rule matches as tasks and run a rule against existing items | T020, T024, T065, T066, T069, T070 | no | done | [T071](T071-commit-grabs-and-run-rule.md) |
