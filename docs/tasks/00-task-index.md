...
| [T127](T127-operator-pause-of-a-parked-task.md) | Keep an operator pause authoritative over a disk-full auto-resume | T022, T099, T128 | done |
| [T128](T128-atomic-claim-of-a-parked-candidate.md) | Claim a parked candidate before the engine resumes it | T099, T126 | done |
...
| [T101](T101-engine-conformance-at-boot.md) | Assert and force engine conformance at boot | T019, T027, T028, T029 | done |
...
| [T047](T047-mkdir-free-space-and-folder-browser.md) | Serve mkdir and free space, and build the folder browser dialog | T046, T099 | done |
...
| [T103](T103-progressive-web-app.md) | Ship the web app manifest, maskable icons and the service worker | T039, T040, T043 | done |
| [T104](T104-accessibility-harness.md) | Add the accessibility harness: axe-core, the keyboard map and aria-rowcount | T042, T043, T044, T045, T048, T049, T051, T053 | done |
...
| [T122](T122-apply-ssrf-guard-to-user-uris.md) | Apply the SSRF guard to user-submitted URIs | T020, T031, T123 | done |
...
| [T073](T073-rule-editor-and-live-preview.md) | Build the rule editor with the live dry-run preview | T047, T050, T068, T070, T071, T072 | done |
...
| [T132](T132-readyz-drain-and-shutdown-order.md) | Withdraw readiness and stop HTTP before the runtime drain | T130 | done |
...
T113, T115, T121, T130, T132 and T133 are M7, and T124 and T125 are M0. A dependency on a numerically higher identifier is
...
| T127 | Keep an operator pause authoritative over a disk-full auto-resume | T022, T099, T128 | yes | done | [T127](T127-operator-pause-of-a-parked-task.md) |
| T128 | Claim a parked candidate before the engine resumes it | T099, T126 | no | done | [T128](T128-atomic-claim-of-a-parked-candidate.md) |
...
| T101 | Assert and force engine conformance at boot | T019, T027, T028, T029 | no | done | [T101](T101-engine-conformance-at-boot.md) |
...
| T047 | Serve mkdir and free space, and build the folder browser dialog | T046, T099 | no | done | [T047](T047-mkdir-free-space-and-folder-browser.md) |
| T048 | Build the detail pane, its tabs and the file tree | T024, T032, T034, T035, T042 | yes | done | [T048](T048-detail-pane-and-file-tree.md) |
| T049 | Build the add-task dialog and the file-selection step | T020, T031, T033, T044, T047, T048, T050 | no | done | [T049](T049-add-task-dialog.md) |
...
| T103 | Ship the web app manifest, maskable icons and the service worker | T039, T040, T043 | yes | done | [T103](T103-progressive-web-app.md) |
| T104 | Add the accessibility harness: axe-core, the keyboard map and aria-rowcount | T042, T043, T044, T045, T048, T049, T051, T053 | yes | done | [T104](T104-accessibility-harness.md) |
...
| T122 | Apply the SSRF guard to user-submitted URIs | T020, T031, T123 | no | done | [T122](T122-apply-ssrf-guard-to-user-uris.md) |
...
| T073 | Build the rule editor with the live dry-run preview | T047, T050, T068, T070, T071, T072 | no | done | [T073](T073-rule-editor-and-live-preview.md) |
...
| T132 | Withdraw readiness and stop HTTP before the runtime drain | T130 | no | done | [T132](T132-readyz-drain-and-shutdown-order.md) |
...
| 2026-09-25 | Added T132 (withdraw readiness and stop HTTP before the runtime drain) — the same audit found `/readyz` can never return 503 during shutdown and the runtime drain precedes the ingress close, inverting doc 17 §2 steps 1–2. |
