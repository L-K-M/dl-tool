...
|---|---|---|---|---|---|
| T001 | Create the Makefile and the doc-lint script | — | no | todo | [T001](T001-makefile-and-doclint.md) |
| T002 | Add the CI workflows and the OpenAPI generation script | T001 | yes | todo | [T002](T002-ci-workflows-and-openapi-gate.md) |
| T003 | Scaffold the Vite SPA build and its toolchain | T001 | yes | todo | [T003](T003-web-build-scaffold.md) |
...
| ID | Title | Depends on | Parallel | Status | File |
|---|---|---|---|---|---|
| T015 | Normalise and decode a submitted URI | T004 | yes | todo | [T015](T015-normalise-submitted-uris.md) |
...
| T021 | List, filter and sort tasks | T017, T020 | no | todo | [T021](T021-list-and-filter-tasks.md) |
